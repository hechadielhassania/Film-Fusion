                        ...
                        <div key={data.id+"bannerHome"+index} className='min-w-full min-h-[450px] lg:min-h-full overflow-hidden relative group transition-all' style={{ transform : `translateX(-${currentImage * 100}%)`}}>
                                ...
                                <div className='container mx-auto'>
                                    <div className=' w-full absolute bottom-0 max-w-md px-3'>
                                        <h2 className='title font-bold text-2xl lg:text-4xl text-white drop-shadow-2xl '>{data?.title || data?.name}</h2>
                                        ...
                                        <Link to={"/"+data?.media_type+"/"+data.id}>
                                            <button  className=' bg-yellow-400 px-10 py-2 text-black font-bold rounded-full mt-4  hover:bg-gradient-to-l from-yellow-600 to-yellow-500 shadow-md transition-all hover:scale-105'>
                                                Play Now
                                            </button>
                                        </Link>
                                    </div>
